...
<div class="clsForm">
  ...
  <div class="clsFromContent">
   	...
   	<div class="clsmodal-header">
        <i class="clsicon fa fa-globe-asia"></i><span>Total Pending Count <span>
      </div>
  ...
  <tr>
   ...
   <td>3000</td>
   <td>6000</td>
   <td><button type='button' class='clsbtnop'><i class='fa fa-print'></i></button><button type='button' class='clsbtnop'><i class='fa fa-info-circle'></i></button></td>
  </tr>
   <tr>
